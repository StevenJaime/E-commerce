...
function pageFilter(){
    ...
    switch(path){
        ...
        case "/men.html":
            ...
            break;
        case "/men_product="+ page +".html":
            state = "men_all";
            track = true;
            document.querySelector(".bred").innerHTML = `<li><a href="/men.html">MEN</a></li><li>/</li>`;
            break;
        case "/men_newarrivals.html":
            ...
            break;
        case "/men_newarrivals="+ page +".html":
            state = "men_newarrivals_all";
            track = true;
            document.querySelector(".bred").innerHTML = `<li><a href="/men.html">MEN</a></li><li>/</li><li><a href="men_newarrivals.html">NEW ARRIVALS</a></li><li>/</li>`;
            break;
        case "/men_shirts.html":
        ...
        case "/women.html":
            ...
            break;
        case "/women_product="+ page +".html":
            state = "ladies_all";
            track = true;
            document.querySelector(".bred").innerHTML = `<li><a href="/women.html">WOMEN</a></li><li>/</li>`;
            break;
        case "/women_newarrivals.html":
            ...
            break;
        case "/women_newarrivals="+ page +".html":
            state = "ladies_newarrivals_all";
            track = true;
            document.querySelector(".bred").innerHTML = `<li><a href="/women.html">WOMEN</a></li><li>/</li><li><a href="women_newarrivals.html">NEW ARRIVALS</a></li><li>/</li>`;
            break;
        case "/women_swimwear.html":
            ...
            break;
        case "/women_swimwear="+ page +".html":
            state = "ladies_swimwear";
            track = true;
            document.querySelector(".bred").innerHTML = `<li><a href="/women.html">WOMEN</a></li><li>/</li><li><a href="women_swimwear.html">SWIMWEAR</a></li><li>/</li>`;
            break;
        case "/women_dress.html":
            ...
            break;
        case "/women_dress="+ page +".html":
            state = "ladies_dresses";
            track = true;
            document.querySelector(".bred").innerHTML = `<li><a href="/women.html">WOMEN</a></li><li>/</li><li><a href="women_dress.html">DRESS</a></li><li>/</li>`;
            break;
        case "/women_accessories.html":
            ...
            break;
        case "/women_accessories="+ page +".html":
            state = "ladies_accessories";
            track = true;
            document.querySelector(".bred").innerHTML = `<li><a href="/women.html">WOMEN</a></li><li>/</li><li><a href="women_accessories.html">ACCESSORIES</a></li><li>/</li>`;
            break;
        case "/women_premium.html":
               ...
               gal.map((item)=>{
                ...
                newLibrary.map((item) => {
                    ...
                    switch(state){
                        ...
                        case "men_all":
                            ad = `<a href ="men_product=${tag}.html"> <li id="${tag}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".ad-products_box").innerHTML += ad;
                            break;
                        case "men_newarrivals_all":
                            ad = `<a href ="men_newarrivals=${tag}.html"> <li id="${tag}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".ad-products_box").innerHTML += ad;
                            break;
                        case "men_tshirtstanks":
                            ad = `<a href ="men_shirts=${tag}.html"> <li id="${tag}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".ad-products_box").innerHTML += ad;  
                            break;
                        case "men_shorts": 
                            ad = `<a href ="men_shorts=${tag}.html"> <li id="${tag}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".ad-products_box").innerHTML += ad;  
                            break;
                        case "men_accessories":
                            ad = `<a href ="men_accessories=${tag}.html"> <li id="${tag}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".ad-products_box").innerHTML += ad;  
                            break;
                        case "men_swimweear":
                            ad = `<a href ="men_swimwear=${tag}.html"> <li id="${tag}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".ad-products_box").innerHTML += ad;  
                            break;
                        case "ladies_all":
                            ad = `<a href ="women_product=${tag}.html"> <li id="${tag}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".ad-products_box").innerHTML += ad;
                            break;
                        case "ladies_newarrivals_all":
                            ad = `<a href ="women_newarrivals=${tag}.html"> <li id="${tag}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".ad-products_box").innerHTML += ad;
                            break;
                        case "ladies_dresses":
                            ad = `<a href ="women_dress=${tag}.html"> <li id="${tag}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".ad-products_box").innerHTML += ad; 
                            break;
                        case "ladies_swimwear":
                            ad = `<a href ="women_swimwear=${tag}.html"> <li id="${tag}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".ad-products_box").innerHTML += ad;
                            break;
                        case "ladies_accessories":
                            ad = `<a href ="women_accessories=${tag}.html"> <li id="${tag}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".ad-products_box").innerHTML += ad;
                            break;
                        case "ladies_premium_selection":
                            ad = `<a href ="women_premium=${tag}.html"> <li id="${tag}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".ad-products_box").innerHTML += ad;
                            break;
                        default:
                ...
                library.map((item) => {
                    ...
                    switch(state){
                        ...
                        case "men_all":
                            shmoney = `<a href ="men_product=${id}.html"> <li id="${id}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".holster").innerHTML += shmoney;  
                            break;
                        case "men_newarrivals_all":
                            shmoney = `<a href ="men_newarrivals=${id}.html" <li id="${id}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".holster").innerHTML += shmoney;
                            break;
                        case "men_tshirtstanks":
                            shmoney = `<a href ="men_shirts=${id}.html" <li id="${id}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".holster").innerHTML += shmoney;  
                            break;
                        case "men_shorts": 
                            shmoney = `<a href ="men_shorts=${id}.html" <li id="${id}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".holster").innerHTML += shmoney;   
                            break;
                        case "men_accessories":
                            shmoney = `<a href ="men_accessories=${id}.html" <li id="${id}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".holster").innerHTML += shmoney;  
                            break;
                        case "men_swimweear":
                            shmoney = `<a href ="men_swimwear=${id}.html" <li id="${id}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".holster").innerHTML += shmoney; 
                            break;
                        case "ladies_all":
                            shmoney = `<a href ="women_product=${id}.html" <li id="${id}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".holster").innerHTML += shmoney;
                            break;
                        case "ladies_newarrivals_all":
                            shmoney = `<a href ="women_newarrivals=${id}.html" <li id="${id}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".holster").innerHTML += shmoney; 
                            break;
                        case "ladies_dresses":
                            shmoney = `<a href ="women_dress=${id}.html" <li id="${id}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".holster").innerHTML += shmoney;
                            break;
                        case "ladies_swimwear":
                            shmoney = `<a href ="women_swimwear=${id}.html" <li id="${id}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".holster").innerHTML += shmoney;
                            break;
                        case "ladies_accessories":
                            shmoney = `<a href ="women_accessories=${id}.html" <li id="${id}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".holster").innerHTML += shmoney;  
                            break;
                        case "ladies_premium_selection":
                            shmoney = `<a href ="women_premium=${id}.html" <li id="${id}"><img src="${image}"> <h2>${name}</h2> <p>${pricey}</p></li></a>`;
                            document.querySelector(".holster").innerHTML += shmoney;  
                            break;
                        default:
...
if (path !== "/index.html" && path !== "/cart.html"){
    go();
    console.log("Api running");
}
